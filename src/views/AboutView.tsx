...
export const AboutView: React.FC<AboutViewProps> = ({
  ...
  const values = [
    ...
    },
    {
      ...
      icon: <HeartHandshake className="w-6 h-6 text-[#0284C7]" />
    }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-20">
          <div className="lg:col-span-6 flex flex-col gap-6">
            <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200">
              <span className="text-xs font-bold uppercase tracking-wider text-[#0284C7] block mb-2">
          ...
          <div className="lg:col-span-6">
            <div className="relative rounded-3xl overflow-hidden shadow-xl border border-slate-200">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0B132B]/90 via-[#0B132B]/30 to-transparent flex flex-col justify-end p-6 sm:p-8 text-white">
                <span className="text-[#38BDF8] text-xs font-bold uppercase tracking-wider mb-1">
